...
CREATE TABLE "new_Inventory" (
    ...
    "saleId" INTEGER,
    FOREIGN KEY ("merchandiseId") REFERENCES "Merchandise" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY ("purchaseId") REFERENCES "Adjustment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Inventory" ("cost", "createdAt", "id", "merchandiseId", "purchaseId", "quantity", "saleId", "updatedAt") SELECT "cost", "createdAt", "id", "merchandiseId", "purchaseId", "quantity", "saleId", "updatedAt" FROM "Inventory";
